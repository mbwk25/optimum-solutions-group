          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div className="font-bold text-xl tracking-tight">
                ...
                <div className="text-xs font-medium text-primary-foreground/60 uppercase tracking-widest mt-0.5">
                  GROUP
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-primary-foreground/90">hello@optimumsolutions.com</span>
              </div>
              <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-primary-foreground/90">Silicon Valley, CA</span>
              </div>
            </div>
